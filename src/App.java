...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // ejecutarRF212(); // Requerimiento 2.12
    ...
    private static void ejecutarRF212() {
        System.out.println("\nRequerimiento RF 2.12: Rechazar archivos con formatos incorrectos");

        try {
            // Probar con un archivo inválido
            Tabla tabla = Tabla.leerDesdeCsv("data/archivo_invalido.csv");
            tabla.visualizar(10, 10, 20);
        } catch (IllegalArgumentException e) {
            System.out.println("Error detectado al cargar archivo inválido: " + e.getMessage());
        }
    }
    ...
    private static void ejecutarRF41() {
        System.out.println("\nRequerimiento RF 4.1: Mostrar cuánto tarda el programa en cargar un CSV");

        // Ruta del archivo CSV
        String rutaCsv = "data/precios.csv";

        try {
            long startTime = System.nanoTime();
            Tabla tabla = Tabla.leerDesdeCsv(rutaCsv, true, ",");
            long endTime = System.nanoTime();

            // Mostrar el tiempo transcurrido
            double duration = (endTime - startTime) / 1_000_000_000.0;
            System.out.printf("Archivo cargado en %.3f segundos\n", duration);
